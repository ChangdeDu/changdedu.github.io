...
- 其次，在“**启发AI**”方面，探索大脑的稀疏性、可塑性、模块化等计算特性，发展受脑启发的新型人工智能框架。通过将神经科学发现反向融入深度网络设计，提升AI模型的表征能力、泛化性能与学习效率。同时，我关注深度神经网络/大语言模型的机制可解释性，推动深度学习从经验性工程向可理解的科学范式转变。
  
- 第三，在“**融合智能**”层面，致力于脑机接口与脑机融合智能的前沿探索，开发高效算法解码大脑活动，实现从神经信号到视觉图像、语音语言与行为动作的跨模态重建；并构建人机协同的混合智能系统，充分发挥生物智能的灵活性与机器智能的精确性优势。
